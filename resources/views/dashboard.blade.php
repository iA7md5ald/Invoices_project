            ...
            <div>
                <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">
                    ...
                    $user=\Illuminate\Support\Facades\Auth::user()->name;
                        $hour = date('H');
                        if ($hour>12){
                            $dayTerm = ' مساء الخير يا   '.$user;
                        }else{
                            $dayTerm = '  صباح الخير يا'.$user;
                        }
                        echo $dayTerm ;
                    @endphp
                </h2>
                        ...
                        <div class="d-flex">
                            ...
                            <span class="float-right my-auto mr-auto">
											...
											<span class="text-white op-7">
                                                {{number_format(\App\Models\Invoices::where('status','مدفوعة')->count() / \App\Models\Invoices::count()*100,2)}}%
                                            </span>
										</span>
                        </div>
                    </div>
            ...
            <div class="card overflow-hidden sales-card bg-warning-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">{{number_format(\App\Models\Invoices::where('status','مدفوعة جزئيا')->sum('total'),2)}}</h4>
                                <p class="mb-0 tx-12 text-white op-7">{{\App\Models\Invoices::where('status','مدفوعة جزئيا')->count()}}</p>
                            </div>
                            <span class="float-right my-auto mr-auto">
											<i class="fas text-white"></i>
											<span class="text-white op-7">
                                                {{number_format(\App\Models\Invoices::where('status','مدفوعة جزئيا')->count() / \App\Models\Invoices::count()*100,2)}}%
                                            </span>
										</span>
                        </div>
                    </div>
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            ...
                            <span class="float-right my-auto mr-auto">
											<i class="fas text-white"></i>
											<span class="text-white op-7">
                                                {{round(\App\Models\Invoices::where('status','غير مدفوعة')->count() / \App\Models\Invoices::count()*100,2)}}%
                                            </span>
										</span>
                        </div>
                    </div>
