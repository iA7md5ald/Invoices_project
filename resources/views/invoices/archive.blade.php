...
{{--                                                                    الفاتورة</a>--}}
                                                                ...
                                                                <a class="dropdown-item" href="#" data-invoice_id="{{ $invoice->id }}" data-toggle="modal" data-target="#move_invoices">&nbsp;&nbsp;نقل الي الفواتير</a>>
                                                            </div>
                                                    </td>
                                                </tr>
                    ...
                    <div class="modal fade" id="move_invoices" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                         aria-hidden="true">
...
@section('js')
    ...
    <script>
        $('#move_invoices').on('show.bs.modal',function (event) {
            var button =$(event.relatedTarget)
            var invoice_id = button.data('invoice_id')
            var modal = $(this)
            modal.find('.modal-body #invoice_id').val(invoice_id)
