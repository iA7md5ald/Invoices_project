...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">الفواتير</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/     قائمة الفواتير الغير المدفوعة</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu tx-13">
                                                                ...
                                                                <a class="dropdown-item"
                                                                   href=" {{ url('show_status') }}/{{ $invoice->id}}">تعديل حالة الدفع</a>                                                           </div>
