							...
							<li class="">
								<div class="dropdown  nav-itemd-none d-md-flex">
									<a href="#" class="d-flex  nav-item nav-link pl-0 country-flag1" data-toggle="dropdown" aria-expanded="false">
										<span class="avatar country-Flag mr-0 align-self-center bg-transparent"><img src="{{URL::asset('assets/img/flags/egy_flag.jpg')}}" alt="img"></span>
										<div class="my-auto">
							...
							<div class="dropdown nav-item main-header-notification">
								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											...
											<span class="badge badge-pill badge-warning mr-auto my-auto float-left"><a
                                                    href="markAll">تعيين الكل كمقروء</a></span>
										</div>

										<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12" id="notifications_count">عدد الاشعارات الغير مقروءة : {{\Illuminate\Support\Facades\Auth::user()->unreadNotifications->count()}} </p>
									</div>
									<div class="main-notification-list Notification-scroll" id="unreadNotifications">
										...
										<a class="d-flex p-3 border-bottom" href="{{ url('invoicesDetails') }}/{{ $notification->data['invoice_id'] }}">
