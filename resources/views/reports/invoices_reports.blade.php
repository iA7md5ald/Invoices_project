                    ...
                    <div class="col-xl-12">
                        <div class="card mg-b-20">
                            <div class="card-header pb-0">
                                <form action="find_invoices" role="search" method="post" autocomplete="off">
                                    @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="invoice_number">
                                            ...
                                            <input type="text" class="form-control" id="invoice_number" name="invoice_number" placeholder="EX-0123">
                                        </div>
                                    </div>
                                    <br>
